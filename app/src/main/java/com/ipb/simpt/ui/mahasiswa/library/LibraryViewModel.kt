...
import com.ipb.simpt.ui.filter.BaseFilterableViewModel
...
class LibraryViewModel : BaseFilterableViewModel() {
    ...
    override fun applyFilters(filterModel: FilterModel) {
        repository.fetchFilteredItems(filterModel) { fetchedItems ->
